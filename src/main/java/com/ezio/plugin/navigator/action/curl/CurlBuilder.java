...
import com.ezio.plugin.utils.StringUtils;
...
public class CurlBuilder {
    ...
    public String build() {
        ...
        return StringUtils.join(delimiter, parts);
    }
...
//        String command = new CurlBuilder(request).build();
//        System.out.println(command);
//        System.out.println(command.equals("curl -X GET \"http://example.com/\""));
//    }
